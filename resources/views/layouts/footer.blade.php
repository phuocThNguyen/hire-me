<div class="container px-2 py-5 mx-auto">
    <div class="flex flex-wrap justify-evenly md:text-left text-center order-first">
    ...
    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2 mb-3">
...
<div class="bg-gray-100">
    <div class="container px-5 pb-2 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href="/">
        ...
        <span class="ml-3 text-xl">HireMe</span>
    </a>
    <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2021 HireMe —

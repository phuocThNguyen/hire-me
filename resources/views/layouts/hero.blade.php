    ...
    <div class="w-full bg-center bg-cover h-screen" style="background-image: url(https://cdn.pixabay.com/photo/2019/07/18/01/17/aston-martin-shooting-brake-zagato-4345303_960_720.jpg);">
        <div class="flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50">
            <div class="text-center">
                <h1 class="text-2xl font-semibold text-white uppercase lg:text-3xl">Rent Your Dream Car Today</h1>
                <button class="w-full px-4 py-2 mt-4 text-sm font-medium text-white uppercase transition-colors duration-200 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Rent car</button>
            </div>
        </div>
    </div>